...
#  --resume weights/pretrain_TimmClassifier_v1_eca_nfnet_l0_0_last

# cd ~/code/kaggle/BLEF/rank1/birdclef-2022/
# sh train_pretrain_now.sh 1 0 v2s 0 /kaggle/input
...
# sh train_pretrain_now.sh 1 0 pre_nf0 0 /kaggle/input
