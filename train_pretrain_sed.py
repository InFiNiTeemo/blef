...
from training.pretrain_dataset import PretrainDatasetSED
...
def create_data_datasets(args):
    ...
    train_dataset = PretrainDatasetSED(dataset_dir=args.data_dir)
    val_dataset = PretrainDatasetSED(dataset_dir=args.data_dir)
